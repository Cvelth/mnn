...
namespace mnnt {
	...
	public:
		LambdaTest(FunctionType function, Type min_value = Type(-1.f), Type max_value = Type(+1.f))
		...
		virtual size_t getInputsNumber() const override { check_network(); return m_network->getInputsNumber(); }
